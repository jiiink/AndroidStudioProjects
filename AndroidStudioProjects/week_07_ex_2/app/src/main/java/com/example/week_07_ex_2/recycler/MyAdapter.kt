package com.example.week_07_ex_2.recycler
...
import com.example.week_07_ex_2.databinding.ItemMainBinding
...
class MyAdapter(val context: Context, val datas: MutableList<ItemModel>?):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        //Glide 활용
        Glide.with(context)
            .load(model.urlToImage) // Assuming imageUrl is the URL of the image
            .into(binding.itemImage) // Assuming itemImage is the ImageView in your layout
    }
}
